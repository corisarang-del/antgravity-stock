        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 w-56 glass rounded-xl border border-border shadow-2xl z-50 overflow-hidden"
            >
              {/* Profile header */}
              <div className="px-4 py-3 border-b border-border">
                <div className="flex items-center justify-between">
                  ...
                  {isPro ? (
                    <span className="text-[10px] px-1.5 py-0.5 rounded bg-primary/20 text-primary border border-primary/30 font-bold flex items-center gap-0.5">
                      <Crown className="w-2.5 h-2.5" /> PRO
                    </span>
                  ) : (

...
import { Search, Brain, TrendingUp, ShieldCheck, Zap, Sparkles, ArrowRight } from "lucide-react";
        ...
        <AnimatePresence>
          {showDropdown && (
            <motion.div
              ...
              className="absolute top-full left-0 right-0 mt-1.5 z-[100] bg-card rounded-xl overflow-hidden border border-border shadow-lg"
            >
              {results.map((stock) => (
                <button
                  key={stock.symbol}

...
import { Brain, BarChart2, Star, Trash2, TrendingUp, TrendingDown, ExternalLink, Plus, Crown } from "lucide-react";
          ...
          <>
            ...
            {!isPro && (
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl border border-primary/30 bg-primary/5 hover:bg-primary/10 transition-colors text-left mb-4"
              >
                <Crown className="w-5 h-5 text-primary shrink-0" />
                <div>
                  <div className="text-sm font-semibold text-primary">Free 플랜 · {watchlist.length}/{FREE_LIMITS.watchlist}개 사용 중</div>
